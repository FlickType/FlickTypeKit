...
@property (nonatomic, strong) IBOutlet WKInterfaceGroup * _Null_unspecified announcementView;
...
@property (nonatomic, strong) IBOutlet WKInterfaceGroup * _Null_unspecified bottomRow;
@property (nonatomic, strong) IBOutlet WKInterfaceGroup * _Null_unspecified spacebar;
...
- (IBAction)handleDeleteTap;
- (IBAction)handleLongPress:(WKLongPressGestureRecognizer * _Nonnull)recognizer;
@end

@class WKInterfaceSKScene;

SWIFT_CLASS("_TtC12FlickTypeKit20FlickTypeController2")
@interface FlickTypeController2 : WKInterfaceController
...
@interface FlickTypeController2 (SWIFT_EXTENSION(FlickTypeKit)) <WKCrownDelegate>
- (void)crownDidRotate:(WKCrownSequencer * _Nullable)crownSequencer rotationalDelta:(double)rotationalDelta;
- (void)crownDidBecomeIdle:(WKCrownSequencer * _Nullable)crownSequencer;
@end
...
@interface FlickTypeScene : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
